...
const gweiHIGH = 30000000000
const gweiLOW = 5000000000
const priceETH = 200

contract('zkToken GAS ANALYSES', async accounts => {
	let Factory
	let DepositVerifier
	...
	before(async() => {
		...
		let initial_transaction = await Factory.zkTokenCreate(Token.address)
		
		let zkTokenAddress = await Factory.getzkTokenAddress(Token.address)
		ZKToken = await zkToken.at(zkTokenAddress)

		console.log("")
		console.log("gweiHIGH = "+ gweiHIGH)
		console.log("gweiLOW  = "+ gweiLOW)
		console.log("priceETH = "+ priceETH)
		console.log("")

		console.log("")
		console.log("ETH transaction HIGH minumum cost = "+ 21000*gweiHIGH/ 10**18+" ETH")
		console.log("ETH transaction HIGH minumum cost = "+ 21000*gweiHIGH/ 10**18 * priceETH+" USD")
		console.log("ETH transaction LOW minumum cost = "+ 21000*gweiLOW/ 10**18+" ETH")
		console.log("ETH transaction LOW minumum cost = "+ 21000*gweiLOW/ 10**18 * priceETH+" USD")
		console.log("")

		console.log(" ")
		console.log("CREATE ZKTOKEN HIGH")
		console.log("gas used create zktoken: "+ initial_transaction.receipt.gasUsed.toString())
		console.log("gas cost ETH: "+ initial_transaction.receipt.gasUsed * gweiHIGH / 10**18+" ETH")
		console.log("gas cost USD: "+ initial_transaction.receipt.gasUsed * gweiHIGH / 10**18 * priceETH+" USD")
		console.log("CREATE ZKTOKEN LOW")
		console.log("gas used create zktoken: "+ initial_transaction.receipt.gasUsed.toString())
		console.log("gas cost ETH: "+ initial_transaction.receipt.gasUsed * gweiLOW / 10**18+" ETH")
		console.log("gas cost USD: "+ initial_transaction.receipt.gasUsed * gweiLOW / 10**18 * 200+" USD")
		console.log(" ")

	})
	describe('zkTokenDeposit()', function () {
		it('deposit analyses', async () => {
			await Token.approve(ZKToken.address, 10)

			let transaction = await ZKToken.deposit(
			...
			console.log(" ")
			console.log("DEPOSIT HIGH")
			console.log("gas used deposit: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18 * priceETH+" USD")
			console.log("DEPOSIT LOW")
			console.log("gas used deposit: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiLOW / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiLOW / 10**18 * 200+" USD")
			console.log(" ")
		})	
	})
	describe('zkTokenTransfer()', function () {
		it('transfer analyses', async () => {
			let transaction = await ZKToken.transfer(
			...
			console.log(" ")
			console.log("TRANSFER HIGH")
			console.log("gas used transfer: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18 * priceETH+" USD")
			console.log("TRANSFER LOW")
			console.log("gas used transfer: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiLOW / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiLOW / 10**18 * 200+" USD")
			console.log(" ")
	...
	describe('zkTokenWithdraw()', function () {
		it('withdraw analyses', async () => {
			let transaction = await ZKToken.withdraw(
			...
			console.log(" ")
			console.log("WITHDRAW HIGH")
			console.log("gas used withdraw: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18 * priceETH+" USD")
			console.log("WITHDRAW LOW")
			console.log("gas used withdraw: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiLOW / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiLOW / 10**18 * 200+" USD")
			console.log(" ")
	...
	describe('zkTokenMixIn()', function () {
		it('Mixer deposit analyses', async () => {
			let transaction = await ZKToken.mixerDeposit(
			...
			console.log(" ")
			console.log("MixIn HIGH")
			console.log("gas used mix in: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18 * priceETH+" USD")
			console.log("MixIn LOW")
			console.log("gas used mix in: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiLOW / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiLOW / 10**18 * 200+" USD")
			console.log(" ")
	...
	describe('zkTokenMixOut()', function () {
		it('Mixer deposit analyses', async () => {
			let transaction = await ZKToken.mixerWithdraw(
			...
			console.log(" ")
			console.log("MixOut HIGH")
			console.log("gas used mix in: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiHIGH / 10**18 * priceETH+" USD")
			console.log("MixOut LOW")
			console.log("gas used mix in: "+transaction.receipt.gasUsed.toString())
			console.log("gas cost ETH: "+ transaction.receipt.gasUsed * gweiLOW / 10**18+" ETH")
			console.log("gas cost USD: "+ transaction.receipt.gasUsed * gweiLOW / 10**18 * 200+" USD")
			console.log(" ")
